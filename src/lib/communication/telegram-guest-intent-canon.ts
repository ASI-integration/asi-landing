...
export const TELEGRAM_GUEST_INTENT_CANON_V1: readonly TelegramGuestCanonRule[] = [
  ...
  },
  {
    ...
    escalate: false,
    reply: 'Поняла вопрос по брони или оплате. Пришлите номер брони, имя гостя или телефон в брони.',
  },
  {
    intent: 'unknown',
    examples: [],
    ...
    actionType: 'none',
    escalate: false,
    reply: 'Поняла. Подскажите, вы про заселение, оплату, доступ к квартире или уже текущее проживание? Я помогу с нужным шагом.',
  },
] as const;

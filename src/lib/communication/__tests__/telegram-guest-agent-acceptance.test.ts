...
const ACCEPTANCE_CASES: AcceptanceCase[] = [
  ...
  },
  {
    ...
    category: 'payment',
    mock: { intent: 'payment_refund', reply: 'Поняла вопрос по возврату. Пришлите номер брони — проверим статус.', needsBookingDetails: true, actionType: 'booking_lookup' },
    expectIntent: 'booking_payment_support',
    expectReplyContains: ['брон'],
  ...
  },
  {
    ...
    category: 'check-in',
    mock: { intent: 'checkin_info_request', reply: 'Поняла. Уточню возможность позднего заселения — пришлите номер брони.', needsBookingDetails: true, actionType: 'booking_lookup' },
    expectReplyContains: ['брон'],
  },
  {
    id: 'natural-03',

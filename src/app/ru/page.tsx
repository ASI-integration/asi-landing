    ...
    <div className="font-sans bg-asi-ivory text-asi-navy antialiased">
      ...
      <main>
        ...
        <BrandSection variant="paper" id="coordination" className="scroll-mt-24">
          ...
          <p className="mt-6 max-w-3xl text-base sm:text-lg text-asi-navy/70 leading-relaxed">
            Бытует мнение, что для роста бизнеса нужно просто набирать новые квартиры. Но на практике выручка растёт, а чистая прибыль часто падает или вовсе уходит в минус.
          </p>
          ...
          <p className="mt-4 max-w-3xl text-base sm:text-lg text-asi-navy/70 leading-relaxed">
            <strong>Как это решает ASI:</strong> Вам не нужно расширять штат с каждым новым объектом. Система берёт всю операционную рутину на себя, позволяя команде всего из 1–2 человек свободно управлять сетью даже в 100 и более квартир без потери качества.
          </p>
        </BrandSection>

    ...
    <ThemeProvider defaultTheme="light" className="theme-transition min-h-screen bg-[var(--t-bg)] text-[var(--t-text)]">
      ...
      <main>
        ...
        <HeroSection content={{
          ...
          aboutBody: 'Бронирования, переписка с гостями, оплаты, коды доступа и задачи клининга исполняются автоматически. Вы получаете доход от портфеля, не нанимая бронистов, администраторов и диспетчеров.',
          aboutPoints: [
            'Коммуникация с гостями 24/7',
            'Бронирования и платежи без оператора',
            'Задачи клининга назначаются сами',
          ],

      ...
      <main>
        ...
        <HeroSection content={{
          ...
          aboutPoints: [
            ...
            'Операционные задачи исполняются автоматически',
          ],
        ...
        <section className="py-12 sm:py-14 px-4 sm:px-6 bg-[var(--t-surface-2)] border-t border-[var(--t-border)]">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-[var(--t-text-2)] text-base leading-relaxed mb-7">
              Даже сильный объект не показывает максимум, если локация выбрана слабо. ASI оценивает спрос, окружение, магниты трафика, конкуренцию и потенциальную доходность ещё до запуска.
            </p>
            <ul className="space-y-2">
              {[
                'Кто и почему будет снимать объект',
                'Какой спрос держится в локации по реальным данным',
            ...
            <div className="grid sm:grid-cols-3 gap-6">
              ...
              >
                ...
                <ul className="mt-4 space-y-2 text-[var(--t-text-2)] text-sm flex-1">
                  ...
                  <li>��бработка типовых запросов гостей</li>
              ...
              >
                ...
                <ul className="mt-4 space-y-2 text-[var(--t-text-2)] text-sm flex-1">
                  ...
                  <li>Для крупных по��тфелей объектов</li>

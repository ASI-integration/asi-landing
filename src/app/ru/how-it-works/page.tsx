      ...
      <main className="px-4 sm:px-6">
        <section className="max-w-4xl mx-auto pt-14 sm:pt-18 pb-10 sm:pb-14">
          ...
          <p className="mt-4 text-[var(--t-text-2)] text-base sm:text-lg leading-relaxed">
            Подробное описание платформы и сценариев работы. Ниже — что уже автоматизируется и в каких ситуациях это применимо прямо сейчас.
          </p>
        ...
        <section className="max-w-4xl mx-auto py-12 sm:py-14 border-t border-[var(--t-border)]">
          ...
          <p className="mt-3 text-[var(--t-text-2)] text-base sm:text-lg leading-relaxed">
            Хотите увидеть, как это будет работать на ваших объектах? Оставьте заявку — посмотрим вместе и предложим конкретный формат подключения.
          </p>
          <div className="mt-6">
            <Link
              href="/connect"

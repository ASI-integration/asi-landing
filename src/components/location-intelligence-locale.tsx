...
> = {
  ...
  ru: {
    ...
    sectionTitle: 'Оценка локации через призму\nдохода, спроса и конкуренции',
    sectionLead:
      'Введите адрес — система рассчитает спрос, конкуренцию и потенциальный доход\nс учётом реального окружения и поведения рынка',
    sectionSub1:

    ...
    <div className="max-w-4xl mx-auto text-asi-navy">
      ...
      <div className="bg-asi-paper border border-asi-border p-5 sm:p-8">
        {step < 3 ? <form onSubmit={save}>
          ...
          {draft.communityMember ? <p className="mt-5 text-sm">Условия группы «Стрегуново» сохранены: настройка 0 ₽, затем 14 дней бесплатно после готовности. Далее — 1 000 ₽ за объект в месяц только по вашему решению, с сохранением цены на 12 месяцев.</p> : null}

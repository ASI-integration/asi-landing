#!/usr/bin/env python3
"""Apply Owner/Object Setup Autopilot v1 migration via SUPABASE_DB_URL or DATABASE_URL."""
...
SQL = (
    ...
    / "supabase/migrations/20260701160000_owner_object_setup_autopilot_v1.sql"
...
def probe(url: str, key: str) -> tuple[bool, str]:
    ...
    r = httpx.get(
        f"{base}/rest/v1/booking_owner_setup_profiles?select=id&limit=1",
        headers=headers,
        timeout=20,
        trust_env=False,
    )

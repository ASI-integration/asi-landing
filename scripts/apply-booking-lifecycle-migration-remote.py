#!/usr/bin/env python3
"""Apply Booking Lifecycle Gates v1 migration on the production VPS without printing secrets."""
...
SQL_FILE = Path("/tmp/booking_lifecycle_gates_v1.sql")
REQUIRED_TABLES = ("booking_lifecycle_gates", "booking_lifecycle_exceptions")

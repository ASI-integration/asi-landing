#!/usr/bin/env python3
"""Apply In-stay & Checkout Autopilot v1 migration on production without printing secrets."""
...
SQL_FILE = Path("/tmp/booking_instay_checkout_v1.sql")
REQUIRED_TABLES = (
    "booking_instay_checkout",
    "booking_guest_stay_issues",
)
